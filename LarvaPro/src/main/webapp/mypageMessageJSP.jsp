					...
					<div class="pc-table">
						...
						<table>
							<tbody>
								<tr>
									<td
										style="font-size: 25px; background-color: gray; color: white; width: 100px;">쪽지
										번호</td>
									<td
										style="font-size: 25px; background-color: gray; color: white; width: 100px;">보낸
										사람</td>
									<td
										style="font-size: 25px; background-color: gray; color: white; width: 300px;">쪽지
										내용</td>
									<td
										style="font-size: 25px; background-color: gray; color: white; width: 100px;">받은
										날짜</td>
								</tr>
