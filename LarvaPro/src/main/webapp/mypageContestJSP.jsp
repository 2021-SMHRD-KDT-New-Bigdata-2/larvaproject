                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="profile-agent-widget">
                            <ul>
                                <li><a href="#" style="color:black">진행중인 공모전 갯수</a><span style="color:red">3</span></li>
                                <li><a href="#" style="color:black">팀원 모집중인 공모전 갯수</a><span style="color:red">1</span></li>
                                <li><a href="#" style="color:black">끝난 공모전 갯수 </a><span style="color:red">4</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="property-item">
                        ...
                        <div class="pi-text">
                            ...
                            <div class="pt-price">10월 23일<span>까지</span></div>
                            <h5><a href="#">열려라 참깨 공모전</a></h5>
                            <ul>
                                <li><i class="fa fa-object-group"></i> IT</li>
                                <li><i class="fa fa-bathtub"></i> 5명</li>
                                <li><i class="fa fa-bed"></i> 팀원</li>
                                <li style="color:red"><i class="fa fa-bed"></i> 모집중</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="property-item">
                        ...
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <div class="pt-price">10월 15일<span>까지</span></div>
                            <h5><a href="#">천하제일 무술대회</a></h5>
                            <ul>
                                <li><i class="fa fa-object-group"></i> 소프트웨어</li>
                                <li><i class="fa fa-bathtub"></i> 3명</li>
                                <li style="color:blue"><i class="fa fa-bed"></i> 팀장</li>
                                <li style="color:red"><i class="fa fa-bed"></i> 모집중</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="property-item">
                        ...
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <div class="pt-price">10월 16일<span>까지</span></div>
                            <h5><a href="#">동명동 와인대회</a></h5>
                            <ul>
                                <li><i class="fa fa-object-group"></i> IT</li>
                                <li><i class="fa fa-bathtub"></i> 5명</li>
                                <li style="color:blue"><i class="fa fa-bed"></i> 팀장</li>
                                <li style="color:green"><i class="fa fa-bed"></i> 모집완료</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="property-item">
                        ...
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <div class="pt-price">10월 30일<span>까지</span></div>
                            <h5><a href="#">소주 많이먹기 대회</a></h5>
                            <ul>
                                <li><i class="fa fa-object-group"></i> 소프트웨어</li>
                                <li><i class="fa fa-bathtub"></i> 4명</li>
                                <li><i class="fa fa-bed"></i> 팀원</li>
                                <li style="color:green"><i class="fa fa-bed"></i> 모집완료</li>
                            </ul>
                        </div>
