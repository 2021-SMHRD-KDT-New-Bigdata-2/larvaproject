                ...
                <div class="col-lg-12 p-0">
                    <div class="pc-table">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                	<td style="background-color: white; color: black; width:50px;">
	                                    	<div>
	                        					<p style="float : left">공모전의 간략한 내용</p>
	                        				</div>
	                                	</td>
	                                </tr>
	                        </table>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td style="font-size: 25px; background-color: gray; color: white; width:100px;">이름</td>
                                    <td style="font-size: 25px; background-color: gray; color: white; width:300px;">직군</td>
                                    <td style="font-size: 25px; background-color: gray; color: white; width:100px;">레벨</td>
                                </tr>
                                <tr>
                ...
                <div class="col-lg-12">
                    <div class="cf-content">
                        <form action="#" class="cc-form">
                            ...
                            <textarea placeholder="팀원 모집에 대한 내용만 작성 바랍니다. 무분별한 광고, 도배는 제재대상입니다."></textarea>
